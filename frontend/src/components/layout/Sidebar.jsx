...
const navItems = [
  ...
  { path: "/workspaces", icon: Layers, label: "Workspaces" },
        ...
        >
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="btn-icon w-7 h-7 p-0 flex items-center justify-center"
              title="Toggle theme"
            >
            ...
            <button
              ...
              className="btn-icon w-7 h-7 p-0 flex items-center justify-center text-red-400 hover:text-red-300"
              title="Logout"
            >
              <LogOut size={13} />
            </button>
